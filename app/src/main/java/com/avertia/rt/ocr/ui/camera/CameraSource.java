...
public class CameraSource {
    ...
    public static class Builder {
        ...
        private DetectorFirebase detector;
         ...
         */
        public Builder(Context context, DetectorFirebase detector) {
            if (context == null) {
    ...
    private class FrameProcessingRunnable implements Runnable {
        ...
        private DetectorFirebase mDetector;
        ...
        FrameProcessingRunnable(DetectorFirebase detector) {
            mDetector = detector;
        }
